...
//    }
    ...
    public HashMap<String, Course> unmarshal(Course[] v) throws Exception {
        System.out.println("The size  in unmarshall is "+v.length);
...
//        return map;
    ...
    @Override
    public Course[] marshal(HashMap<String, Course> b) throws Exception {
       
//        HashMap<String,Course> v = b;
//        Set<String> keySet = v.keySet();
//        Iterator<String> keyIter = keySet.iterator();
//        System.out.println("The brochure id is "+b);
//        
//        System.out.println("The iter size "+keySet.size());
//        ListCourse lc = new ListCourse();
//        
